    ...
    <div>
      <div>
        <motion.h1
          ...
          className="text-center lg:text-7xl md:text-4xl text-3xl font-bold text-black "
        >
          {" "}
      ...
      <div
        className="container mx-auto grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-3 py-3 px-3"
        data-aos="fade-up"
      >
        {queries.map((query) => (
